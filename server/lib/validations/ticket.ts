...
export const ticketSchema = z.object({
  ...
  descriptionSr: z.string().trim().optional().nullable(),
  titleSr: z.string().trim().optional().nullable(),
  imageUrl: z.string().trim().url("Molimo unesite ispravan URL slike").optional().nullable().or(z.literal("")),
...
export const ticketGroupSchema = z.object({
  ...
  titleSr: z.string().optional().nullable(),
  description: z.string().optional().nullable(),
  descriptionSr: z.string().optional().nullable(),
  displayOrder: z.coerce.number().default(0),
  isActive: z.boolean().default(true),
