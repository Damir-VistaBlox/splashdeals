...
function ResetPasswordForm() {
  ...
  // Note: Missing token UI is handled by conditional rendering below
    ...
    return (
      <Card className="border-red-500/10 bg-red-500/5 backdrop-blur-2xl p-8 text-center space-y-6">
        ...
        <Button asChild className="bg-red-500 hover:bg-red-600 text-white font-black uppercase tracking-widest text-[10px] rounded-xl px-8 h-10">
          <Link href="/auth/forgot-password">Request New Token</Link>
        </Button>
      </Card>
    );
  }
            ...
            {success ? (
              ...
              >
                ...
                <Button asChild variant="ghost" className="text-cyan-500 text-[10px] font-black uppercase tracking-widest">
                    <Link href="/auth/login">Click if not redirected</Link>
                </Button>
              </motion.div>
            ) : (
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        required
                        disabled={loading}
                        className="h-12 bg-white/5 border-white/10 focus-visible:ring-cyan-500/50 rounded-xl transition-all"
                      />
                      <button
                        type="button"
