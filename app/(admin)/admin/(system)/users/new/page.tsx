  ...
  return (
    <div className="flex flex-col gap-8 p-4 md:p-6 max-w-2xl mx-auto w-full relative">
        <div className="flex items-center gap-4 animate-in fade-in slide-in-from-left-4 duration-500">
            ...
            <div>
            <h1 className="text-2xl font-black tracking-tighter text-white uppercase italic">Onboard Admin</h1>
        ...
        <div className="bg-slate-900/50 border border-white/5 rounded-2xl p-8 backdrop-blur-xl relative overflow-hidden">
