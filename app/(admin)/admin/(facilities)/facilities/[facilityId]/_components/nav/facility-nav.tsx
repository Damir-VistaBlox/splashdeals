...
export function FacilityNav({ facility, counts }: FacilityNavProps) {
  ...
  const tabs = React.useMemo(() => [
      ...
      { 
        ...
        icon: "account_circle", 
        active: isTabActive(`/admin/facilities/${facility.id}/profile`) && searchParams.get('section') !== 'amenities' 
      },
      { 
        title: "Amenities", 
        href: `/admin/facilities/${facility.id}/profile?section=amenities`, 
        icon: "grid_view", 
        active: isTabActive(`/admin/facilities/${facility.id}/profile`) && searchParams.get('section') === 'amenities', 
    ...
    ], [facility.id, pathname, counts, searchParams])
