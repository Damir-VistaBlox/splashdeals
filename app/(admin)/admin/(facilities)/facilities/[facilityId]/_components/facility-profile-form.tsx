...
import { CompactAmenitiesTable } from "./amenities"
        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 pb-32">
          ...
          <div className="xl:col-span-8 space-y-6">
            ...
            <section id="amenities" className="scroll-mt-32 space-y-4">
              <div className="flex items-center gap-3">
                <Icon name="auto_awesome" className="size-4 text-emerald-400" />
                <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-white/70">Facility Infrastructure & Feature Registry</h2>
              </div>
            ...
            {/* Operations Cluster */}
            <section id="operations" className="scroll-mt-32 space-y-4">
              <div className="flex items-center gap-3">
                <Icon name="schedule" className="size-4 text-amber-400" />
                <h2 className="text-[11px] font-black uppercase tracking-[0.2em] text-white/70">Operations & Logistics</h2>
              </div>
              <div className="grid grid-cols-1 gap-6">
                <OperationsTable facilityId={facility.id} initialHours={initialHours} />
              </div>
            </section>
