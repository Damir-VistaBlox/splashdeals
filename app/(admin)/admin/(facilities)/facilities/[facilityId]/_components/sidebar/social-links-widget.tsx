    ...
    <GlassCard className="p-5 border-white/10 bg-slate-900/40 backdrop-blur-sm">
      <div className="flex items-center justify-between mb-5">
         <div className="flex items-center gap-2">
           ...
           <h3 className="text-[10px] font-black uppercase tracking-widest text-white">Social Links</h3>
         </div>
      ...
      <div className="space-y-4">
         <div className="space-y-1.5">
           <div className="flex justify-between items-center">
             <Label className="text-[9px] font-black uppercase tracking-widest text-slate-500">Instagram URL</Label>
         ...
         <div className="space-y-1.5">
           <div className="flex justify-between items-center">
             <Label className="text-[9px] font-black uppercase tracking-widest text-slate-500">Facebook URL</Label>
         ...
         <div className="space-y-1.5">
           <div className="flex justify-between items-center">
             <Label className="text-[9px] font-black uppercase tracking-widest text-slate-500">Official Website</Label>
