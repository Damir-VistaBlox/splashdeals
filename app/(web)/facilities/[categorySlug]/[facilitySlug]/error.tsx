    ...
    <div className="relative min-h-screen bg-background text-white flex items-center justify-center p-6 md:p-12 overflow-hidden selection:bg-red-500/20">
      ...
      <Card className="max-w-xl w-full p-8 md:p-16 border-red-500/10 bg-white/5 relative z-10 text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
           ...
           <Link 
             href={``}
             className="px-8 py-4 rounded-2xl bg-slate-100 hover:bg-white text-[#020617] font-black uppercase tracking-widest text-[10px] flex items-center justify-center gap-2 shadow-2xl shadow-white/5 transition-all"
           >
