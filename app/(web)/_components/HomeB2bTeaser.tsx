...
export function HomeB2bTeaser({ dict }: { dict: HomeDict }) {
  return (
    <section className="mx-auto hidden max-w-7xl px-4 py-10 sm:px-6 md:block md:px-12">
      <Card className="border-border bg-muted/20 flex flex-col items-start justify-between gap-5 p-5 sm:flex-row sm:items-center sm:gap-6 sm:p-8">
