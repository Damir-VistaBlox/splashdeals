  ...
  return (
    <div className="relative z-0 w-full overflow-hidden pb-8 sm:pb-20">
      <section className="relative mx-auto max-w-7xl px-3 pt-4 sm:px-6 sm:pt-10 md:px-8">
        <div className="section-shell overflow-hidden rounded-[1.75rem] px-4 py-6 sm:px-8 sm:py-14 lg:px-12 lg:py-16">
          <div className="animate-fade-up relative z-10 flex flex-col items-center text-center">
            ...
            <h1 className="from-foreground to-foreground/72 mb-2.5 max-w-4xl bg-gradient-to-b via-sky-950 bg-clip-text text-[clamp(2.45rem,7.7vw,6.6rem)] leading-[0.9] font-black tracking-[-0.07em] text-transparent sm:mb-5">
            ...
            <p className="text-muted-foreground mx-auto mb-4 max-w-[18rem] text-[0.95rem] leading-relaxed font-medium sm:mb-9 sm:max-w-2xl sm:text-[clamp(1rem,2.4vw,1.15rem)]">
              {dict.subtitle}
            </p>

            <div className="mb-2.5 flex w-full max-w-md flex-col items-stretch gap-2 sm:max-w-none sm:flex-row sm:items-center sm:justify-center sm:gap-4">
              <Button
                asChild
            ...
            <p className="text-muted-foreground mb-4 max-w-[17rem] text-[10px] leading-relaxed font-bold tracking-[0.12em] uppercase sm:mb-12 sm:max-w-none sm:text-[11px]">
              Brza kupovina. Jasna ponuda. Ulaznice za nekoliko sekundi.
            </p>

            <div className="public-panel mt-1 w-full max-w-5xl rounded-[1.5rem] border border-white/70 p-3.5 shadow-[0_18px_40px_rgba(15,23,42,0.05)] sm:mt-0 sm:p-5 lg:p-6">
              <div className="mb-3 flex flex-col items-center gap-1 sm:mb-5 sm:gap-2">
                <span className="text-primary text-[10px] font-black tracking-[0.18em] uppercase">
                  Kreni odmah
                </span>
                <p className="text-foreground max-w-[17rem] text-[15px] leading-tight font-black text-balance sm:max-w-none sm:text-base">
