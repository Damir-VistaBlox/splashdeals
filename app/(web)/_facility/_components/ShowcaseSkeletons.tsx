...
export function TicketGridSkeleton() {
  return (
    <div className="mx-auto w-full max-w-6xl animate-pulse space-y-8 pb-24 md:pb-0">
      {/* Tabs Placeholder */}
      <div className="border-border flex h-14 w-full items-center gap-2 rounded-full border bg-white/5 p-1">
        <Skeleton className="h-full w-32 rounded-full bg-white/10" />
        <Skeleton className="h-full w-28 rounded-full bg-white/5" />
        <Skeleton className="h-full w-36 animate-pulse rounded-full bg-white/5" />
      </div>
      ...
      <div className="hidden gap-4 md:grid">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="border-border flex h-28 items-center justify-between rounded-3xl border bg-white/[0.02] p-6"
          >
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="border-border flex h-10 w-24 items-center rounded-xl border bg-black/20 p-1">
      ...
      <div className="block space-y-4 md:hidden">
        {[1, 2, 3].map((i) => (
          <div
            key={i}
            className="border-border flex flex-col gap-5 rounded-3xl border bg-white/[0.02] p-6"
          >
            <div className="space-y-2">
            ...
            <div className="flex gap-3">
              <div className="border-border flex h-12 w-28 items-center rounded-2xl border bg-black/25 p-1">
