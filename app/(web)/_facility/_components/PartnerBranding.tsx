...
export function PartnerBranding({ logoUrl, name }: PartnerBrandingProps) {
  ...
  return (
    <div className="glass-frost border-border bg-muted/20 hover:border-primary/20 hover:bg-muted/40 group flex items-center gap-5 rounded-[2rem] border p-6 transition-all duration-500">
      ...
      <div>
        <div className="mb-1 flex items-center gap-1.5 text-[9px] font-black tracking-[0.2em] text-cyan-400 uppercase">
          <Icon name="verified" className="fill-cyan-500/20 text-[14px]" /> Zvanični Partner
        </div>
        <h4 className="max-w-[160px] text-base leading-tight font-black tracking-tight text-white uppercase">
          {name}
        </h4>
      </div>
    </div>
