  ...
  return (
    <div className="min-h-screen pb-32 pt-32 px-6 sm:px-12 max-w-5xl mx-auto animate-pulse">
      ...
      <header className="mb-20 space-y-6">
        ...
        <h1 className="text-5xl sm:text-7xl font-black tracking-tighter uppercase italic leading-[0.9] text-slate-800 select-none pointer-events-none">Politika Kolačića</h1>
