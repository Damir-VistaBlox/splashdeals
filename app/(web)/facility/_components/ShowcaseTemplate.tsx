...
export async function FacilityShowcaseTemplate({ params }: FacilityPageProps) {
  ...
  return (
    <div className="text-foreground selection:bg-primary/30 relative min-h-screen font-sans">
      ...
      <main className="relative z-20 mx-auto -mt-16 max-w-7xl space-y-12 px-6 pb-24 sm:space-y-32 sm:pb-48 md:-mt-24 md:px-12 [scroll-padding-top:8rem]">
            ...
            <Card className="brand-card flex min-h-0 flex-col justify-center">
              ...
              <CardContent className="space-y-6 p-6 sm:p-12 md:p-16">
                ...
                <div className="flex flex-wrap gap-3 pt-2">
                  <a
                    href="#deals"
                    className="bg-primary text-primary-foreground hover:bg-primary/90 inline-flex items-center gap-2 rounded-full px-6 py-3 text-xs font-black tracking-wider uppercase shadow-lg transition-all"
                  >
