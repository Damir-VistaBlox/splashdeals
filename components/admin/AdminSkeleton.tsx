...
export function AdminSkeleton() {
  return (
    <div className="flex h-screen w-full bg-[#020617]">
      {/* Sidebar Placeholder */}
      <div className="hidden lg:flex flex-col w-[280px] border-r border-white/5 p-4 gap-4">
      ...
      <div className="flex-1 flex flex-col">
        {/* Top Bar */}
        <div className="h-[60px] border-b border-white/5 flex items-center px-6 gap-4">
        ...
        <div className="flex-1 p-6">
          ...
          <Skeleton className="h-5 w-96 bg-white/5 mt-2" />
