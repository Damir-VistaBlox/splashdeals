...
export function TodayHoursBadge({ hours }: TodayHoursBadgeProps) {
  ...
  return (
    <div className="flex items-center gap-3 bg-white/5 border border-white/5 rounded-xl px-4 py-2 backdrop-blur-md">
       <div className="flex flex-col">
          <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest leading-none mb-1">Current Status</p>
       ...
       <div className="flex flex-col">
          <p className="text-[8px] font-black text-slate-500 uppercase tracking-widest leading-none mb-1">Window</p>
          <p className="text-xs font-bold text-white tabular-nums tracking-tighter">
