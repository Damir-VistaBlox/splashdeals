...
export const GlobalAmbient = () => {
  return (
    <div className="fixed inset-0 -z-50 overflow-hidden pointer-events-none">
      ...
      <div
        className="absolute top-[-20%] left-[-20%] w-[80%] h-[80%] rounded-full bg-cyan-600/10 blur-[150px] animate-kinetic-1"
      />

      <div
        className="absolute bottom-[-10%] right-[-10%] w-[70%] h-[70%] rounded-full bg-blue-600/10 blur-[120px] animate-kinetic-2"
      />
