        ...
        create: [
          {
            ...
            items: {
              create: [
                {
                  id: "seed-item-istrazi-0",
                  label: "Akva Parkovi",
                  href: "/akva-parkovi",
                  icon: "pool",
                  desc: "Vodeni parkovi i tobogani",
                  sortOrder: 0,
                },
                {
                  id: "seed-item-istrazi-1",
                  label: "Bazeni",
                  href: "/bazeni",
                  icon: "waves",
                  desc: "Gradski i otvoreni bazeni",
                  sortOrder: 1,
                },
                {
                  id: "seed-item-istrazi-2",
                  label: "Banje",
                  href: "/banje",
                  icon: "spa",
                  desc: "Termalni izvori i spa centri",
                  sortOrder: 2,
                },
                {
                  id: "seed-item-istrazi-3",
                  label: "Svi objekti",
                  href: "/svi-objekti",
                  icon: "map",
                  desc: "Pregled svih destinacija",
                  sortOrder: 3,
                },
              ],
            },
        ...
        create: [
          {
            ...
            items: {
              create: [
                {
                  id: "seed-item-biznis-0",
                  label: "Postanite partner",
                  href: "/za-biznis",
                  sortOrder: 0,
                },
                {
                  id: "seed-item-biznis-1",
                  label: "Prodajne opcije",
                  href: "/za-biznis/prodaja",
                  sortOrder: 1,
                },
        ...
        create: [
          {
            ...
            items: {
              create: [
                {
                  id: "seed-item-korisnici-0",
                  label: "Kontrolna tabla",
                  href: "/dashboard",
                  icon: "dashboard",
                  desc: "Pregled aktivnosti",
                  sortOrder: 0,
                },
                {
                  id: "seed-item-korisnici-1",
                  label: "Moje karte",
                  href: "/dashboard/tickets",
                  icon: "confirmation_number",
                  desc: "Kupljene ulaznice",
                  sortOrder: 1,
                },
                {
                  id: "seed-item-korisnici-2",
                  label: "Podešavanja",
