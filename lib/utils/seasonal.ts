/**
 * Calculates the exact end date of the Summer Season in Central Europe (Serbia).
 * Rule: Last Sunday of October at 03:00 AM (Clock moves back to winter time).
 */
...
/**
 * Calculates the start of the Summer Season in Central Europe (Serbia).
 * Rule: Last Sunday of March at 02:00 AM (Clock moves forward to summer time).
 */
